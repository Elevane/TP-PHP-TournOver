...
<!--
nom :createCarousselCsv.php
fonction : le but de ce script est de réinitialisé la contenu de la partie acceuil qui contient le caroussel.
-->
...
// script de sécurité, si la personne ne s'est pas connecté, il est impossible d'acceder a la page , renvoies ensuite vers la page d'erreur (cf bas de page)
{
	...
	$list = [
		[0,"img/RS6.jpg"], // on définie une liste "type"

	];
	$fp = fopen('caroussel.csv','w'); // on enregistre dans une variable, l'ouverture du fichierr csv en mode écriture
