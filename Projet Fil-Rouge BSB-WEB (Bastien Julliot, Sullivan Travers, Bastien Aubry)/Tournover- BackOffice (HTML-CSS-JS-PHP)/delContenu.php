...
// script de sécurité, si la personne ne s'est pas connecté, il est impossible d'acceder a la page , renvoies ensuite vers la page d'erreur (cf bas de page)
{
	...
	$fp = fopen('contenu.csv', 'r'); // ouvrir le csv en lecture
	...
	$fp = fopen('contenu.csv', 'w'); // ouvrir le csv en écriture
	...
	header('Location:gestionNosEvenements.php'); // renvois au panneaux de gestion de contenu
